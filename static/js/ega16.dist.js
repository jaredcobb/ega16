...
(function audioInstance($) {
  var audio = {
    ...
    initialize: function initialize() {
      ...
      if (self.audioStatus === 'on') {
        ...
        if (EGA16.audio_page_hash !== 'undefined') {
          $.each(EGA16.audio_page_hash, function (index, value) {
    ...
    initializeCookies: function initializeCookies() {
      var self = this;
    ...
    toggleAudio: function toggleAudio() {
      ...
      if (self.audioStatus === 'on') {
        ...
        self.audioStatus = 'on';
        self.$toggleButton.text('Sound: on');
        if (typeof EGA16.audio_toggle_file !== 'undefined' && EGA16.audio_toggle_file.length) {
...
(function crtInstance($) {
  var crt = {
     ...
     */
    toggleCRT: function toggleCRT() {
      var self = crt;

      if (self.crtStatus === 'on') {
        self.$body.removeClass('crt-on').removeClass('crt-toggle-on').addClass('crt-toggle-off');
        self.crtStatus = 'off';
        $('canvas.pixelated').remove();
        self.$toggleButton.text('CRT: off');
      } else {
        self.$body.removeClass('crt-toggle-off').addClass('crt-on').addClass('crt-toggle-on');
        self.crtStatus = 'on';
        self.drawImages();
     ...
     */
    loadJSON: function loadJSON(callback) {
    ...
    mapColorToPalette: function mapColorToPalette(red, green, blue) {
      ...
      var diffG = void 0;
      var diffB = void 0;
      var diffDistance = void 0;
      var mappedColor = void 0;
      if (self.rgbColors.length > 0) {
        for (var i = 0; i < self.rgbColors.length; i += 1) {
     ...
     * new RGB object
     */
    parseHexObject: function parseHexObject() {
      var self = this;
      $.each(self.sassVariables, function (key, value) {
    ...
    hexToRgb: function hexToRgb(hex) {
      ...
      var parsedHex = hex;
      parsedHex = parsedHex.replace(shorthandRegex, function (m, r, g, b) {
        return r + r + g + g + b + b;
      });
...
(function pointsInstance($) {
  var points = {
    ...
    initialize: function initialize() {
      ...
      if (EGA16.points_enabled === '1') {
        if (typeof EGA16.points_page_selectors !== 'undefined') {
          for (var i = 0; i < EGA16.points_page_selectors.length; i += 1) {
            if (self.$body.hasClass(EGA16.points_page_selectors[i]) && $.inArray(EGA16.points_page_selectors[i], self.awardedPages) === -1) {
        ...
        if (typeof EGA16.points_click_selectors !== 'undefined') {
          for (var _i = 0; _i < EGA16.points_click_selectors.length; _i += 1) {
            $(EGA16.points_click_selectors[_i]).data('click-selector', EGA16.points_click_selectors[_i]).on('click', self.awardClickPoints);
          }
        }
      }
    },
    ...
    awardClickPoints: function awardClickPoints() {
      var self = points;
      var clickSelector = $(this).data('click-selector');
...
//# sourceMappingURL=ega16.dist.js.map
